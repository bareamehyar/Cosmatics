...
@section("content")
    <div class="row">
        <div class="col-lg-10 m-auto">
            <form method="post" action="{{route("items.add_ons.update",[$item->id,$addOn->id,app()->getLocale()])}}" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="tile">
                            ...
                            <div class="col-lg-6" >
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio1" name="choice_type" class="custom-control-input" value="1"  {{checked("choice_type", 1,$addOn, 'which_choice')}}>
                                        <label class="custom-control-label" for="customRadio1">Single</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio2" name="choice_type" class="custom-control-input" value="2" {{checked("choice_type", 2,$addOn, 'which_choice')}}>
