                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <th>{{ $user->is_admin ? "Super Admin" : ($user->role ? $user->role->name : null)}}</th>
                                <td>{{$user->created_at->diffForHumans()}}</td>
                                <td>{{$user->updated_at->diffForHumans()}}</td>
                                <td>
                                    <a href="{{route("admins.edit",[$user->id,app()->getLocale()])}}" class="control-link edit"><i class="fas fa-edit"></i></a>
