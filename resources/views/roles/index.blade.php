                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            @foreach($roles as $role)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route("roles.edit", [$role->id,app()->getLocale()])}}" class="control-link edit"><i class="fas fa-edit"></i></a>
                                        <form action="{{route("roles.destroy", [$role->id,app()->getLocale()])}}" method="post" id="delete{{$role->id}}" style="display: none" data-swal-title="Delete Role" data-swal-text="Are Your Sure To Delete This Role ?" data-yes="Yes" data-no="No" data-success-msg="the role has been deleted succssfully">@csrf @method("delete")</form>
