...
@section("page-nav-title")
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>Cashier table </h1>
            <p>Control and view all cashier</p>
        </div>
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route("users.app.destroy", [$user->id,app()->getLocale()])}}" method="post" id="delete{{$user->id}}" style="display: none">@csrf @method("delete")</form>
