...
@section("content")
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                <h3 class="tile-title">Add New Area</h3>
                <div class="tile-body">
                    <form method="post" action="{{route("area.store", [$city->id,app()->getLocale()])}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label">Area name</label>
                                    <input class="form-control @if($errors->has('area_name')) is-invalid @endif" type="text" name="area_name" placeholder="Enter Area Name" value="{{inputValue("area_name")}}">
                                </div>
                                @error("area_name")
