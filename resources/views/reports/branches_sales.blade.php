...
@section("content")
    ...
    <div class="row">
        <div class="col-lg-12 mb-3 text-right">
            <a href="{{route("reports.branches_sales.export.excel",app()->getLocale())}}" class="btn btn-primary"><i class="far fa-fw fa-lg  fa-file-excel text-left"></i> Export As Excel</a>
        </div>
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
