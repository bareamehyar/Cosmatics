    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form method="post" action="{{route("branches.update", [$branch->id,app()->getLocale()])}}">
                        @csrf
                        @method("put")
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('branch_name')) is-invalid @endif" type="text" name="branch_name" placeholder="Branch name" value="{{inputValue("branch_name", $branch, "store_name")}}">
                                </div>
                                @error("branch_name")
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="exampleSelect1" name="category_id">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{$category->id}}" {{selected("category_id", $category->id, $branch)}}>{{$category->name_en}} ( {{$category->name_ar}} )</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error("category_id")
