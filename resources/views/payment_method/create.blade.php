...
@section("content")
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                <h3 class="tile-title">Add New Payment Method</h3>
                <div class="tile-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('title')) is-invalid @endif" type="text" name="title" placeholder="Enter Payment Title" value="{{inputValue("title")}}">
                                </div>
                                @error("title")
