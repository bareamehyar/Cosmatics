...
@section("page-nav-title")
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route("branches.index",app()->getLocale())}}">edit profile</a></li>
        </ul>
    </div>
@endsection
@section("content")
    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form method="post" action="{{route("profile.save",app()->getLocale())}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
