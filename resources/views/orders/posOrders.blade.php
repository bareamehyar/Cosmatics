                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            <div class="row">
                                ...
                                <div class="col-lg-8 p-4 text-right">
                                    <form action="{{route("orders.export.excel",app()->getLocale())}}" method="post" id="form-excel">
                                        @csrf
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route("orders.details", [$order->id,app()->getLocale()])}}" class="control-link"><i class="far fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
