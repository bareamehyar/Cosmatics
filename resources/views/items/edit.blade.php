    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form method="post" action="{{route("items.update",[$item->id,app()->getLocale()])}}" enctype="multipart/form-data">
                        @csrf
                        @method("put")
                        <div class="row">
                            <div class="col-lg-6">
                                    ...
                                    <select class="form-control @if($errors->has('branches_ids')) is-invalid @endif" id="demoSelect" multiple="" name="branches_ids[]">
                                        <optgroup label="Select Branches">
                                            @foreach($branches as $branch)
                                                <option value="{{$branch->id}}" {{isset($itemDefaultBranches[$branch->id]) ? "selected" : null}}>{{$branch->store_name}}</option>
                                            @endforeach
                                        </optgroup>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if($errors->has('item_tax')) is-invalid @endif" type="text" name="item_tax" placeholder="Enter Item Tax" value="{{inputValue("item_tax", $item, "tax")}}">
                                </div>
                                @error("item_tax")
                                <div class="input-error">{{$message}}</div>
                                @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="toggle-flip">
                                    <label>
                                        <input type="checkbox" name="item_status" {{checked("item_status", ['on'=>true, 1 => true], $item)}}><span class="flip-indecator" data-toggle-on="ON" data-toggle-off="OFF"></span>
                                    </label>
                                </div>
                            </div>
