    ...
    <div class="row">
        <div class="col-lg-10 m-auto">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form method="post" action="{{route("branch.slider.save",app()->getLocale())}}" enctype="multipart/form-data">
                        @if(count($errors) > 0)
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <button class="btn btn-primary form-control button-upload-file" >
                                            <input class="input-file show-uploaded" data-upload-type="multi" data-imgs-container-class="uploaded-images" type="file" name="images[]" multiple>
